...
MODEL=facebook/opt-2.7b TASK=SST2 MODE=ft LR=1e-5 bash finetune.sh
...
MODEL=facebook/opt-2.7b TASK=SST2 MODE=ft LR=1e-5 NUM_GPU=4 bash finetune_fsdp.sh

# meta-llama/Llama-3.2-3B
# MeZO (full-parameter, prefix-tuning, and LoRA)
MODEL=facebook/opt-1.3b TASK=SST2 MODE=ft LR=1e-7 EPS=1e-3 bash mezo.sh
